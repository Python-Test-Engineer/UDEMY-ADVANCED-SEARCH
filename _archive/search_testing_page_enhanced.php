<?php
/**
 * Plugin Name: ✅ 20 UDEMY CAPSTONE SET UP RAG MANAGER - Enhanced
...
class Posts_RAG_Manager {
    ...
    public function ajax_create_fulltext_index() {
        ...
        if (isset($_POST['index_categories']) && $_POST['index_categories'] === 'true') {
            $fields[] = 'categories';
        }
        if (isset($_POST['index_tags']) && $_POST['index_tags'] === 'true') {
            $fields[] = 'tags';
        }
        if (isset($_POST['index_custom']) && $_POST['index_custom'] === 'true') {
            $fields[] = 'custom_meta_data';
        }
    ...
    public function admin_page() {
                ...
                <?php if (!$index_exists): ?>
                    <div id="index-creation-form">
                        ...
                        <p style="margin-left: 20px;">
                            ...
                            <label style="display: block; margin: 5px 0;">
                                <input type="checkbox" id="index-categories"> 
                                <strong>categories</strong> - Post categories
                            </label>
                            <label style="display: block; margin: 5px 0;">
                                <input type="checkbox" id="index-tags"> 
                                <strong>tags</strong> - Post tags
                            </label>
                            <label style="display: block; margin: 5px 0;">
                                <input type="checkbox" id="index-custom"> 
                                <strong>custom_meta_data</strong> - Custom fields and ACF data
                            </label>
                        </p>
                        <p class="description">
                            Recommended: Select <strong>post_title</strong> and <strong>post_content</strong> for best search results.<br>
                            You can include additional fields for more comprehensive search coverage.
                        </p>
        ...
        jQuery(document).ready(function($) {
            ...
            $('#create-fulltext-btn').on('click', function() {
                ...
                var indexCategories = $('#index-categories').is(':checked');
                var indexTags = $('#index-tags').is(':checked');
                var indexCustom = $('#index-custom').is(':checked');
                
                if (!indexTitle && !indexContent && !indexCategories && !indexTags && !indexCustom) {
